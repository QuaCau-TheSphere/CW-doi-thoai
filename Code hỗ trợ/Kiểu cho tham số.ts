...
/** Source */
export type KýHiệuDiễnĐàn = 'F' | 'L' | 'R' | 'Y' 
type KýHiệuLoạiDiễnĐàn = 'G' | 'Pg' | 'Pr' | 'Sub'
type KýHiệuSourceDiễnĐàn = `${KýHiệuDiễnĐàn} ${KýHiệuLoạiDiễnĐàn}`
...
export type Source = `${KýHiệuSourceDiễnĐàn | KýHiệuSourceNềnTảngChat | string} ${TênNơiĐăng}`
