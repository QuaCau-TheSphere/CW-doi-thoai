...
export default function tạoDanhSáchNơiĐăng(cấuHìnhNơiĐăng: CấuHìnhNơiĐăng) {
    ...
    function tạoDanhSáchNơiĐăngDiễnĐàn() {
        for (const [tênDiễnĐàn, vậtThểNơiĐăngDiễnĐàn] of Object.entries(cấuHìnhNơiĐăng["Diễn đàn"]) as [TênDiễnĐàn, VậtThểNơiĐăngDiễnĐàn][]) {
            for (const [loạiNơiĐăngDiễnĐàn, danhSáchNơiĐăngDiễnĐàn] of Object.entries(vậtThểNơiĐăngDiễnĐàn)) {
                ...
                for (const nơiĐăngDiễnĐàn of danhSáchNơiĐăngDiễnĐàn) {
                    ...
                    if (typeof nơiĐăngDiễnĐàn === 'string') {
                        ...
                        for (const [tênTàiKhoảnHoặcTrangHoặcNhóm, danhSáchThànhPhần] of Object.entries(nơiĐăngDiễnĐàn)) {
                            ...
                            /** Trường hợp tài khoản/trang/nhóm có thành phần nhỏ hơn */
                                ...
                                for (const thànhPhần of danhSáchThànhPhần) {
                                    danhSáchNơiĐăng.push({
                                    'Tên nơi đăng': `${thànhPhần} ${tênTàiKhoảnHoặcTrangHoặcNhóm}`,
                                    'Loại nơi đăng': loạiNơiĐăngDiễnĐàn as LoạiNơiĐăngDiễnĐàn,
                                    "Tên nền tảng": tênDiễnĐàn,
                                    "Loại nền tảng": "Diễn đàn"
                                    });
    ...
    function lấyNơiĐăngTừCộngĐồngChat(tênNềnTảng: 'Discord' | 'Messenger' | 'Telegram') {
        ...
        if (tênNềnTảng === "Messenger") {
            ...
            console.error('Không phải là máy chủ Discord, Messenger cộng đồng hoặc nhóm Telegram')
            return
        } 
