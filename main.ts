...
import { THƯ_MỤC_CHỨA_TẤT_CẢ_CÁC_VAULT, TÊN_MIỀN_RÚT_GỌN, ĐƯỜNG_DẪN_ĐẾN_TẬP_TIN_CSV } from "./Code%20h%E1%BB%97%20tr%E1%BB%A3/H%E1%BA%B1ng.ts";
...
const bàiĐăng = danhSáchVậtThểBàiĐăng.find(e => e["Tiêu đề"].includes('Các buổi'))
const nơiĐăng = danhSáchNơiĐăng.find(e => e["Tên nơi đăng"].includes('Các buổi'))
const thamSốUTMVàLiênKếtRútGọn = tạoThamSốUTMVàLiênKếtRútGọn(nơiĐăng!, bàiĐăng!, await chỉSốLầnĐăngTrước() + 1, cấuHìnhNơiĐăng) 
