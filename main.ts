...
// const vậtThểKếtQuả = tạoKếtQuảPhânLoại(Deno.args[0] as CâuNhập, cấuHìnhCóVẻHợpLệ) 
...
} satisfies VậtThểKếtQuảPhânLoại

const tiêuĐềTrang = vậtThểKếtQuảPhânLoại["Bài viết"] as string
function lấyURL(_tiêuĐềTrang: string) {
    return 'https://example.com' //TODO
} 
const url = lấyURL(tiêuĐềTrang) 
const vậtThểNộiDung = { 
    url: url, 
    "Tiêu đề": tiêuĐềTrang,
