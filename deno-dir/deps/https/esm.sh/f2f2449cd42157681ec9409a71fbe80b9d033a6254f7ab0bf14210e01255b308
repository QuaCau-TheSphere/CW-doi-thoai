import htmlDecodeTree from "./generated/decode-data-html.d.ts";
import xmlDecodeTree from "./generated/decode-data-xml.d.ts";
import decodeCodePoint from "./decode_codepoint.d.ts";
export { htmlDecodeTree, xmlDecodeTree, decodeCodePoint };
export { replaceCodePoint, fromCodePoint } from "./decode_codepoint.d.ts";
